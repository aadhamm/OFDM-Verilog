// -------------------------------------------------------------
// 
// File Name: D:\NU\OF\WHDLOFDMTransmitterExample_all_new\hdl_prj\hdlsrc3\whdlOFDMTransmitter_up_con\whdlOFDMTx\whdlOFDMTx_RADIX22FFT_SDF2_4.v
...
// Source Path: dsphdl.IFFT/RADIX22FFT_SDF2_4
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module whdlOFDMTx_RADIX22FFT_SDF2_4
  ...
  input   reset;
  input   enb_1_32_0;
  input   signed [15:0] dout_3_1_re;  // sfix16_En14
  input   signed [15:0] dout_3_1_im;  // sfix16_En14
  input   dout_3_1_vld;
  input   [2:0] rd_4_Addr;  // ufix3
  input   rd_4_Enb;
  input   proc_4_enb;
  input   multiply_4_J;
  ...
  whdlOFDMTx_SDFCommutator4 u_SDFCOMMUTATOR_4 (.clk(clk),
                                               .reset(reset),
                                               .enb_1_32_0(enb_1_32_0),
...
endmodule  // whdlOFDMTx_RADIX22FFT_SDF2_4
