// -------------------------------------------------------------
// 
// File Name: D:\NU\OF\WHDLOFDMTransmitterExample_all_new\hdl_prj\hdlsrc3\whdlOFDMTransmitter_up_con\whdlOFDMTx\whdlOFDMTx_SDFCommutator1.v
...
module whdlOFDMTx_SDFCommutator1
  ...
  reg signed [15:0] dout_1_1_re_1;  // sfix16_En14
  reg signed [15:0] dout_1_1_im_1;  // sfix16_En14
  reg  dout_1_1_vld_1;
    ...
    case ( SDFCummutator_mem_btf_switch)
      ...
      2'b01 :
        begin
          SDFCummutator_mem_btf_switch_next = 2'b01;
          SDFCummutator_rdEnb_xmem_next = 1'b0;
          if ((SDFCummutator_rdCnt == 6'b111111) && btf_vld) begin
...
endmodule  // whdlOFDMTx_SDFCommutator1
