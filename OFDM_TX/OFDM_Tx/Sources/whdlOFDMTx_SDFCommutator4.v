// -------------------------------------------------------------
// 
// File Name: D:\NU\OF\WHDLOFDMTransmitterExample_all_new\hdl_prj\hdlsrc3\whdlOFDMTransmitter_up_con\whdlOFDMTx\whdlOFDMTx_SDFCommutator4.v
...
// Source Path: dsphdl.IFFT/RADIX22FFT_SDF2_4/SDFCommutator4
// Hierarchy Level: 6
// 
// -------------------------------------------------------------
...
module whdlOFDMTx_SDFCommutator4
  ...
  output  wrEnb;
  output  signed [15:0] dout_4_1_re;  // sfix16_En14
  output  signed [15:0] dout_4_1_im;  // sfix16_En14
  output  dout_4_1_vld;
  ...
  reg signed [15:0] dout_4_1_re_1;  // sfix16_En14
  reg signed [15:0] dout_4_1_im_1;  // sfix16_En14
  reg  dout_4_1_vld_1;
  ...
  always @(SDFOutmux_btf2Pipe_im, SDFOutmux_btf2Pipe_re, SDFOutmux_btfPipe_vld, dout0_im,
    ...
    dout_4_1_re_1 = SDFOutmux_btf2Pipe_re;
    dout_4_1_im_1 = SDFOutmux_btf2Pipe_im;
    dout_4_1_vld_1 = SDFOutmux_btfPipe_vld;
  end
  ...
  assign dout_4_1_re = dout_4_1_re_1;

  assign dout_4_1_im = dout_4_1_im_1;

  assign dout_4_1_vld = dout_4_1_vld_1;

endmodule  // whdlOFDMTx_SDFCommutator4
