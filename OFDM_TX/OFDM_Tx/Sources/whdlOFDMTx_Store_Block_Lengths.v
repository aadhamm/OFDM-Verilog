// -------------------------------------------------------------
// 
// File Name: D:\NU\OF\WHDLOFDMTransmitterExample_all_new\hdl_prj\hdlsrc3\whdlOFDMTransmitter_up_con\whdlOFDMTx\whdlOFDMTx_Store_Block_Lengths.v
...
// Source Path: whdlOFDMTx/Frame Generator/Data/Data Chain/Symbol Interleaver/Interleaver/Store_Block_Lengths
// Hierarchy Level: 7
// 
// -------------------------------------------------------------
...
module whdlOFDMTx_Store_Block_Lengths
  ...
  wire w_mux1;  // ufix1
  reg  w_d1;  // ufix1
  wire [8:0] w_waddr_1;  // ufix9
  reg [8:0] w_d2;  // ufix9
  wire [8:0] w_out;  // ufix9
  ...
  whdlOFDMTx_SimpleDualPortRAM_generic_block1 #(.AddrWidth(2),
                                              ...
                                              u_Store_Block_Lengths_ram_generic (.clk(clk),
                                                                                 .enb(enb),
                                                                                 .wr_din(In),
                                                                                 .wr_addr(w_waddr),
                                                                                 .wr_en(w_we),  // ufix1
...
endmodule  // whdlOFDMTx_Store_Block_Lengths
