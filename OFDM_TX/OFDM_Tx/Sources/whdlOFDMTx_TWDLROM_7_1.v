// -------------------------------------------------------------
// 
// File Name: D:\NU\OF\WHDLOFDMTransmitterExample_all_new\hdl_prj\hdlsrc3\whdlOFDMTransmitter_up_con\whdlOFDMTx\whdlOFDMTx_TWDLROM_7_1.v
...
// Source Path: dsphdl.IFFT/TWDLROM_7_1
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module whdlOFDMTx_TWDLROM_7_1
  ...
  input   enb_1_32_0;
  input   dout_6_1_vld;
  output  signed [15:0] twdl_7_re;  // sfix16_En14
  output  signed [15:0] twdl_7_im;  // sfix16_En14
  ...
  reg  twdl45Reg;
  reg signed [15:0] twdl_7_re_1;  // sfix16_En14
  reg signed [15:0] twdl_7_im_1;  // sfix16_En14
  ...
  always @(Radix22TwdlMapping_cnt, Radix22TwdlMapping_dvldReg1,
    ...
    if (dout_6_1_vld && (Radix22TwdlMapping_cnt > 5'b01111)) begin
      Radix22TwdlMapping_phase_next = Radix22TwdlMapping_phase + 2'b01;
    end
    if (dout_6_1_vld) begin
      Radix22TwdlMapping_cnt_next = Radix22TwdlMapping_cnt + 5'b10000;
    end
  ...
  always @(twdl45Reg, twdlOctantReg, twiddleReg_im, twiddleReg_re) begin
    ...
    twdl_7_re_1 = Radix22TwdlOctCorr_twdlIn_re;
    twdl_7_im_1 = Radix22TwdlOctCorr_twdlIn_im;
  end



  assign twdl_7_re = twdl_7_re_1;

  assign twdl_7_im = twdl_7_im_1;

endmodule  // whdlOFDMTx_TWDLROM_7_1
