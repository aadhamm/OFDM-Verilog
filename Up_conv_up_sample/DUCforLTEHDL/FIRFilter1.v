// -------------------------------------------------------------
// 
// File Name: D:\OFDM\HDLImplementationOfDUCForLTEExample(Single Tone Output)\HDLImplementationOfDUCForLTEExample\hdlsrc\complex_upsampler\DUCforLTEHDL\FIRFilter1.v
...
// 
// Module: FIRFilter1
// Source Path: DUCforLTEHDL/HDL_DUC/CIC Compensation Interpolator/DUCforLTEHDL/HDL_DUC/CIC Compensation Interpolator/FIRFilter1
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module FIRFilter1
  ...
  always @(rdAddr3) begin
    case ( rdAddr3)
      2'b00 :
        begin
          coeffTableOut3 = 18'sb000000001000011111;
        end
      2'b01 :
        begin
          coeffTableOut3 = 18'sb111111011100000000;
        end
      2'b10 :
        begin
          coeffTableOut3 = 18'sb000000001000110001;
        end
      2'b11 :
        begin
          coeffTableOut3 = 18'sb000000000110010011;
        end
      default :
        begin
  ...
  always @(rdAddr2) begin
    case ( rdAddr2)
      2'b00 :
        begin
          coeffTableOut2 = 18'sb010100111011100100;
        end
      2'b01 :
        begin
          coeffTableOut2 = 18'sb111100111010110101;
        end
      2'b10 :
        begin
          coeffTableOut2 = 18'sb111110000001000011;
        end
      2'b11 :
        begin
          coeffTableOut2 = 18'sb000001100110111001;
        end
      default :
        begin
  ...
  always @(rdAddr1) begin
    case ( rdAddr1)
      2'b00 :
        begin
          coeffTableOut1 = 18'sb111110110100111111;
        end
      2'b01 :
        begin
          coeffTableOut1 = 18'sb111111011111000100;
        end
      2'b10 :
        begin
          coeffTableOut1 = 18'sb000100001001101110;
        end
      2'b11 :
        begin
          coeffTableOut1 = 18'sb111011101110111110;
        end
      default :
        begin
  ...
  always @(rdAddr0_1) begin
    case ( rdAddr0_1)
      2'b00 :
        begin
          coeffTableOut0 = 18'sb000000000100110011;
        end
      2'b01 :
        begin
          coeffTableOut0 = 18'sb111111110011010010;
        end
      2'b10 :
        begin
          coeffTableOut0 = 18'sb000000001011110010;
        end
      2'b11 :
        begin
          coeffTableOut0 = 18'sb000000100011011011;
        end
      default :
        begin
  ...
  Addressable_Delay_Line_block u_delayLine0_1 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
  ...
  Addressable_Delay_Line_block u_delayLine1_1 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
  ...
  Addressable_Delay_Line_block u_delayLine2_1 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
  ...
  Addressable_Delay_Line_block u_delayLine3_1 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
  ...
  always @(rdAddr3) begin
    case ( rdAddr3)
      2'b00 :
        begin
          coeffTableOut3_1 = 18'sb000000001000011111;
        end
      2'b01 :
        begin
          coeffTableOut3_1 = 18'sb111111011100000000;
        end
      2'b10 :
        begin
          coeffTableOut3_1 = 18'sb000000001000110001;
        end
      2'b11 :
        begin
          coeffTableOut3_1 = 18'sb000000000110010011;
        end
      default :
        begin
  ...
  always @(rdAddr2) begin
    case ( rdAddr2)
      2'b00 :
        begin
          coeffTableOut2_1 = 18'sb010100111011100100;
        end
      2'b01 :
        begin
          coeffTableOut2_1 = 18'sb111100111010110101;
        end
      2'b10 :
        begin
          coeffTableOut2_1 = 18'sb111110000001000011;
        end
      2'b11 :
        begin
          coeffTableOut2_1 = 18'sb000001100110111001;
        end
      default :
        begin
  ...
  always @(rdAddr1) begin
    case ( rdAddr1)
      2'b00 :
        begin
          coeffTableOut1_1 = 18'sb111110110100111111;
        end
      2'b01 :
        begin
          coeffTableOut1_1 = 18'sb111111011111000100;
        end
      2'b10 :
        begin
          coeffTableOut1_1 = 18'sb000100001001101110;
        end
      2'b11 :
        begin
          coeffTableOut1_1 = 18'sb111011101110111110;
        end
      default :
        begin
  ...
  always @(rdAddr0_1) begin
    case ( rdAddr0_1)
      2'b00 :
        begin
          coeffTableOut0_1 = 18'sb000000000100110011;
        end
      2'b01 :
        begin
          coeffTableOut0_1 = 18'sb111111110011010010;
        end
      2'b10 :
        begin
          coeffTableOut0_1 = 18'sb000000001011110010;
        end
      2'b11 :
        begin
          coeffTableOut0_1 = 18'sb000000100011011011;
        end
      default :
        begin
  ...
  FilterTapSystolic_block u_filterTap0_1 (.clk(clk),
                                          .enb(enb),
  ...
  FilterTapSystolic_block u_filterTap1_1 (.clk(clk),
                                          .enb(enb),
  ...
  FilterTapSystolic_block u_filterTap2_1 (.clk(clk),
                                          .enb(enb),
  ...
  FilterTapSystolic_block u_filterTap3_1 (.clk(clk),
                                          .enb(enb),
