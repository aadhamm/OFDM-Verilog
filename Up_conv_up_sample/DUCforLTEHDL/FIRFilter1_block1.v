// -------------------------------------------------------------
// 
// File Name: D:\OFDM\HDLImplementationOfDUCForLTEExample(Single Tone Output)\HDLImplementationOfDUCForLTEExample\hdlsrc\complex_upsampler\DUCforLTEHDL\FIRFilter1_block1.v
...
module FIRFilter1_block1
  ...
  reg signed [15:0] coeffTableReg4_3;  // sfix16_En15
  ...
  reg signed [15:0] coeffTableReg3_3;  // sfix16_En15
  ...
  reg signed [15:0] coeffTableReg2_3;  // sfix16_En15
  wire signed [15:0] delayLineEnd8_1;  // sfix16_En15
  ...
  reg signed [15:0] coeffTableReg1_3;  // sfix16_En15
  wire signed [15:0] delayLineEnd9deadOut_1;  // sfix16_En15
  wire signed [15:0] delayLineDataOut9_1;  // sfix16_En15
  reg signed [15:0] coeffTableOut0_1;  // sfix16_En15
  reg signed [15:0] coeffTableRegP0_3;  // sfix16_En15
  reg signed [15:0] coeffTableReg0_3;  // sfix16_En15
  ...
  Addressable_Delay_Line_block10 u_delayLine4 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
  ...
  Addressable_Delay_Line_block11 u_delayLine5 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
  ...
  Addressable_Delay_Line_block12 u_delayLine6 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
  ...
  Addressable_Delay_Line_block12 u_delayLine7 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
  ...
  Addressable_Delay_Line_block12 u_delayLine8 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
  ...
  Addressable_Delay_Line_block12 u_delayLine9 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
  ...
  FilterTapSystolicPreAdd_block1 u_filterTap1 (.clk(clk),
                                               .enb(enb),
  ...
  FilterTapSystolicPreAdd_block1 u_filterTap2 (.clk(clk),
                                               .enb(enb),
  ...
  FilterTapSystolicPreAdd_block1 u_filterTap3 (.clk(clk),
                                               .enb(enb),
  ...
  FilterTapSystolicPreAdd_block1 u_filterTap4 (.clk(clk),
                                               .enb(enb),
  ...
  assign validOutLookahead_reg_next_1[0] = delayLineShiftEn5_1;
  ...
  assign rdAddrEndNonZero_1 = rdAddr5 != 4'b0000;
  ...
  Addressable_Delay_Line_block13 u_delayLine0_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
  ...
  Addressable_Delay_Line_block13 u_delayLine1_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
  ...
  Addressable_Delay_Line_block13 u_delayLine2_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
  ...
  Addressable_Delay_Line_block13 u_delayLine3_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
  ...
  Addressable_Delay_Line_block14 u_delayLine4_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
  ...
  Addressable_Delay_Line_block15 u_delayLine5_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
  ...
  always @(rdAddr4) begin
    case ( rdAddr4)
      4'b0000 :
        begin
          coeffTableOut4_1 = 16'sb0000001011010100;
        end
      4'b0001 :
        begin
          coeffTableOut4_1 = 16'sb1111110010101101;
        end
      4'b0010 :
        begin
          coeffTableOut4_1 = 16'sb0000001111101100;
        end
      4'b0011 :
        begin
          coeffTableOut4_1 = 16'sb1111101101011000;
        end
      4'b0100 :
        begin
          coeffTableOut4_1 = 16'sb0000010110010111;
        end
      4'b0101 :
        begin
          coeffTableOut4_1 = 16'sb1111100100101100;
        end
      4'b0110 :
        begin
          coeffTableOut4_1 = 16'sb0000100010010100;
        end
      4'b0111 :
        begin
          coeffTableOut4_1 = 16'sb1111010010111011;
        end
      4'b1000 :
        begin
          coeffTableOut4_1 = 16'sb0001000000001000;
        end
      4'b1001 :
        begin
          coeffTableOut4_1 = 16'sb1110010100000000;
        end
      4'b1010 :
        begin
          coeffTableOut4_1 = 16'sb0101000101101111;
        end
      4'b1011 :
        begin
  ...
  Addressable_Delay_Line_block16 u_delayLine6_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
  ...
  always @(rdAddr3) begin
    case ( rdAddr3)
      4'b0000 :
        begin
          coeffTableOut3_1 = 16'sb0000000000110101;
        end
      4'b0001 :
        begin
          coeffTableOut3_1 = 16'sb1111111111100000;
        end
      4'b0010 :
        begin
          coeffTableOut3_1 = 16'sb0000000000001001;
        end
      4'b0011 :
        begin
          coeffTableOut3_1 = 16'sb0000000000010001;
        end
      4'b0100 :
        begin
          coeffTableOut3_1 = 16'sb1111111111010010;
        end
      4'b0101 :
        begin
          coeffTableOut3_1 = 16'sb0000000001001110;
        end
      4'b0110 :
        begin
          coeffTableOut3_1 = 16'sb1111111110001101;
        end
      4'b0111 :
        begin
          coeffTableOut3_1 = 16'sb0000000010011011;
        end
      4'b1000 :
        begin
          coeffTableOut3_1 = 16'sb1111111100110111;
        end
      4'b1001 :
        begin
          coeffTableOut3_1 = 16'sb0000000011111011;
        end
      4'b1010 :
        begin
          coeffTableOut3_1 = 16'sb1111111011001100;
        end
      4'b1011 :
        begin
          coeffTableOut3_1 = 16'sb0000000101110011;
        end
      4'b1100 :
        begin
          coeffTableOut3_1 = 16'sb1111111001000110;
        end
      4'b1101 :
        begin
          coeffTableOut3_1 = 16'sb0000001000001011;
        end
      4'b1110 :
        begin
          coeffTableOut3_1 = 16'sb1111110110010111;
        end
      default :
        begin
  ...
  Addressable_Delay_Line_block16 u_delayLine7_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
  ...
  always @(rdAddr2) begin
    case ( rdAddr2)
      4'b0000 :
        begin
          coeffTableOut2_1 = 16'sb1111111101111100;
        end
      4'b0001 :
        begin
          coeffTableOut2_1 = 16'sb0000000010000111;
        end
      4'b0010 :
        begin
          coeffTableOut2_1 = 16'sb1111111101110110;
        end
      4'b0011 :
        begin
          coeffTableOut2_1 = 16'sb0000000010001100;
        end
      4'b0100 :
        begin
          coeffTableOut2_1 = 16'sb1111111101110011;
        end
      4'b0101 :
        begin
          coeffTableOut2_1 = 16'sb0000000010001101;
        end
      4'b0110 :
        begin
          coeffTableOut2_1 = 16'sb1111111101110101;
        end
      4'b0111 :
        begin
          coeffTableOut2_1 = 16'sb0000000010001000;
        end
      4'b1000 :
        begin
          coeffTableOut2_1 = 16'sb1111111101111100;
      ...
      4'b1001 :
        begin
          coeffTableOut2_1 = 16'sb0000000001111110;
        end
      4'b1010 :
        begin
          coeffTableOut2_1 = 16'sb1111111110001001;
        end
      4'b1011 :
        begin
          coeffTableOut2_1 = 16'sb0000000001101110;
        end
      4'b1100 :
        begin
          coeffTableOut2_1 = 16'sb1111111110011101;
        end
      4'b1101 :
        begin
          coeffTableOut2_1 = 16'sb0000000001010110;
        end
      4'b1110 :
        begin
          coeffTableOut2_1 = 16'sb1111111110111010;
        end
      default :
        begin
  ...
  Addressable_Delay_Line_block16 u_delayLine8_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
                                                 .dataIn(delayLineEnd7_1),  // sfix16_En15
                                                 .validIn(delayLineShiftEn2_1),
                                                 .wrAddr(wrAddr2),  // ufix4
                                                 .rdAddr(rdAddReverse2),  // ufix4
                                                 .delayLineEnd(delayLineEnd8_1),  // sfix16_En15
  ...
  always @(rdAddr1) begin
    case ( rdAddr1)
      4'b0000 :
        begin
          coeffTableOut1_1 = 16'sb0000000000101011;
        end
      4'b0001 :
        begin
          coeffTableOut1_1 = 16'sb1111111111001111;
        end
      4'b0010 :
        begin
          coeffTableOut1_1 = 16'sb0000000000110111;
        end
      4'b0011 :
        begin
          coeffTableOut1_1 = 16'sb1111111111000011;
        end
      4'b0100 :
        begin
          coeffTableOut1_1 = 16'sb0000000001000100;
        end
      4'b0101 :
        begin
          coeffTableOut1_1 = 16'sb1111111110110110;
        end
      4'b0110 :
        begin
          coeffTableOut1_1 = 16'sb0000000001010001;
        end
      4'b0111 :
        begin
          coeffTableOut1_1 = 16'sb1111111110101001;
        end
      4'b1000 :
        begin
          coeffTableOut1_1 = 16'sb0000000001011110;
        end
      4'b1001 :
        begin
          coeffTableOut1_1 = 16'sb1111111110011100;
        end
      4'b1010 :
        begin
          coeffTableOut1_1 = 16'sb0000000001101010;
        end
      4'b1011 :
        begin
          coeffTableOut1_1 = 16'sb1111111110010000;
        end
      4'b1100 :
        begin
          coeffTableOut1_1 = 16'sb0000000001110110;
        end
      4'b1101 :
        begin
          coeffTableOut1_1 = 16'sb1111111110000101;
        end
      4'b1110 :
        begin
          coeffTableOut1_1 = 16'sb0000000010000000;
        end
      default :
        begin
  ...
  Addressable_Delay_Line_block16 u_delayLine9_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
                                                 .dataIn(delayLineEnd8_1),  // sfix16_En15
                                                 .validIn(delayLineShiftEn1_1),
                                                 .wrAddr(wrAddr1),  // ufix4
                                                 .rdAddr(rdAddReverse1),  // ufix4
                                                 .delayLineEnd(delayLineEnd9deadOut_1),  // sfix16_En15
                                                 .dataOut(delayLineDataOut9_1)  // sfix16_En15
                                                 );
  ...
  always @(rdAddr0_1) begin
    case ( rdAddr0_1)
      4'b0000 :
        begin
          coeffTableOut0_1 = 16'sb0000000000101010;
        end
      4'b0001 :
        begin
          coeffTableOut0_1 = 16'sb1111111110101111;
        end
      4'b0010 :
        begin
      ...
      4'b0011 :
        begin
          coeffTableOut0_1 = 16'sb1111111111111111;
        end
      4'b0100 :
        begin
          coeffTableOut0_1 = 16'sb1111111111111001;
        end
      4'b0101 :
        begin
          coeffTableOut0_1 = 16'sb0000000000000110;
        end
      4'b0110 :
        begin
          coeffTableOut0_1 = 16'sb1111111111111000;
        end
      4'b0111 :
        begin
          coeffTableOut0_1 = 16'sb0000000000001010;
        end
      4'b1000 :
        begin
          coeffTableOut0_1 = 16'sb1111111111110011;
        end
      4'b1001 :
        begin
          coeffTableOut0_1 = 16'sb0000000000010000;
        end
      4'b1010 :
        begin
          coeffTableOut0_1 = 16'sb1111111111101100;
        end
      4'b1011 :
        begin
          coeffTableOut0_1 = 16'sb0000000000011000;
        end
      4'b1100 :
        begin
          coeffTableOut0_1 = 16'sb1111111111100100;
        end
      4'b1101 :
        begin
      ...
      4'b1110 :
        begin
          coeffTableOut0_1 = 16'sb1111111111011010;
        end
      default :
        begin
