// -------------------------------------------------------------
// 
// File Name: D:\OFDM\HDLImplementationOfDUCForLTEExample(Single Tone Output)\HDLImplementationOfDUCForLTEExample\hdlsrc\complex_upsampler\DUCforLTEHDL\Lowpass_Interpolator.v
...
module Lowpass_Interpolator
  ...
  wire ValidPipeline1;
  reg signed [17:0] intdelay_reg_re [0:3];  // sfix18_En14 [4]
  reg signed [17:0] intdelay_reg_im [0:3];  // sfix18_En14 [4]
  wire signed [17:0] intdelay_reg_next_re [0:3];  // sfix18_En14 [4]
  wire signed [17:0] intdelay_reg_next_im [0:3];  // sfix18_En14 [4]
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_1_process
      if (reset == 1'b1) begin
        ...
        intdelay_reg_re[3] <= 18'sb000000000000000000;
        intdelay_reg_im[3] <= 18'sb000000000000000000;
      end
      else begin
        if (enb) begin
          if (syncReset == 1'b1) begin
            ...
            intdelay_reg_re[3] <= intdelay_reg_next_re[3];
            intdelay_reg_im[3] <= intdelay_reg_next_im[3];
          end
        end
      end
    end

  assign FIROutputCastDBP1_re = intdelay_reg_re[3];
  assign FIROutputCastDBP1_im = intdelay_reg_im[3];
  ...
  assign intdelay_reg_next_re[3] = intdelay_reg_re[2];
  assign intdelay_reg_next_im[3] = intdelay_reg_im[2];
