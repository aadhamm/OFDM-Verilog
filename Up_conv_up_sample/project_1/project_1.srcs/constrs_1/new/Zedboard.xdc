...
#   /__   \__
#  / \===\   \==/
# /_\===\___\/  AVNET Design Resource Center
...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {Out4_re_out[0]}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {Out4_re_out[1]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {Out4_re_out[2]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {Out4_re_out[3]}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {Out4_re_out[4]}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {Out4_re_out[5]}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {Out4_re_out[6]}];  # "JA9"
set_property PACKAGE_PIN AA8  [get_ports {Out4_re_out[7]}];  # "JA10"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {Out4_re_out[8]}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {Out4_re_out[9]}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {Out4_re_out[10]}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports  {Out4_re_out[11]}];  # "JB4"
set_property PACKAGE_PIN V12 [get_ports {Out4_re_out[12]}];  # "JB7"
set_property PACKAGE_PIN W10 [get_ports {Out4_re_out[13]}];  # "JB8"
set_property PACKAGE_PIN V9 [get_ports  {Out4_re_out[14]}];  # "JB9"
set_property PACKAGE_PIN V8 [get_ports  {Out4_re_out[15]}];  # "JB10"

# ----------------------------------------------------------------------------
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB6 [get_ports {data}];  # "JC1_N"
#set_property PACKAGE_PIN AB7 [get_ports {data[1]}];  # "JC1_P"
#set_property PACKAGE_PIN AA4 [get_ports {data[2]}];  # "JC2_N"
#set_property PACKAGE_PIN Y4  [get_ports {data[3]}];  # "JC2_P"
#set_property PACKAGE_PIN T6  [get_ports {data[4]}];  # "JC3_N"
#set_property PACKAGE_PIN R6  [get_ports {data[5]}];  # "JC3_P"
#set_property PACKAGE_PIN U4  [get_ports {data[6]}];  # "JC4_N"
#set_property PACKAGE_PIN T4  [get_ports {data[7]}];  # "JC4_P"

# ----------------------------------------------------------------------------
# JD Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W7 [get_ports {Out3}];  # "JD1_N"
set_property PACKAGE_PIN V7 [get_ports {clk_out2}];  # "JD1_P"
#set_property PACKAGE_PIN V4 [get_ports {ce_out_0}];  # "JD2_N"
#set_property PACKAGE_PIN V5 [get_ports {data[10]}];  # "JD2_P"
#set_property PACKAGE_PIN W5 [get_ports {data[11]}];  # "JD3_N"
#set_property PACKAGE_PIN W6 [get_ports {data[12]}];  # "JD3_P"
#set_property PACKAGE_PIN U5 [get_ports {data[13]}];  # "JD4_N"
#set_property PACKAGE_PIN U6 [get_ports {clk_out1}];  # "JD4_P"
...
set_property PACKAGE_PIN U21 [get_ports {ce_out}];  # "LD3"
